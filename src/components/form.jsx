...
// step3:jfiy
    ...
    console.log("fhfgjhg",this.state.data)
...
this.setState({ data: {...this.state.data,  img:`data:image/png;base64,${base64String}`} })
        ...
        <div className="login-form">
          ...
          <div className="form-group">
            <select
              ...
              name="country"
              onChange={(e) => this.setState({ data: {...this.state.data,country:e.target.value} })}

            >
              <option>Country</option>
              <option value={this.state.data.country}>IND</option>
              <option value={this.state.data.country}>USA</option>
            </select>{" "}
          </div>
          <div className="form-group">
            <input
              ...
              onChange={(e) => this.setState({ data: {...this.state.data,state:e.target.value} })}
          ...
          <div className="form-group">
            <input
              ...
              placeholder="City"
              name="city"
              onChange={(e) => this.setState({ data: {...this.state.data,city:e.target.value} })}
